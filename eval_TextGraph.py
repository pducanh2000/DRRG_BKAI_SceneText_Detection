...
from dataset import TotalText, Ctw1500Text, Icdar15Text, Mlt2017Text, TD500Text, BKAIText
...
def main(vis_dir_path):
    ...
    model.load_modEvaluation_Protocolel(model_path)
